...
{
//////////////////////////////////
    QString str = convertFileEncoding("C:/Users/86135/Desktop/人工智能/_大数据_专升本_23_1 .txt");
...
////////////////////////////////////////////////////
    ...
    for(int i =0;i<strlist.size();++i)
    {
        ...
        {
            pair = qMakePair(strlist[i].mid(2,1).toInt(),strlist[i].mid(4).toInt());
        }
        else if (strlist[i][0] == '@' && strlist[i][1] == '#')
        {
            ...
            for(int k = 0; k < j; ++k,i+=6)
            {
                ...
                {
                    QString str = strlist[i].mid(2);
                    for(auto& c:str)
                    {
                        if(c!='_')
                        {
                            week.push_back(c.digitValue());
                        }
                    }
