...
{
    localCache->updateCachingData(ui->comboBox_1->currentText(),ui->comboBox_2->currentText(),ui->comboBox_3->currentText().toInt(),ui->comboBox_4->currentText().toInt(),ui->comboBox_5->currentText().toInt(),true);
