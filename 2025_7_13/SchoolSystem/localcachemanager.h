...
public:
    ...
    // 缓存表操作
    bool updateCachingData(const QString& major, const QString& educationLevel, int grade, int classNum, int weekNum, bool updated);
...
private:
    ...
    bool createTables();
    bool saveCachingData(const QString& major, const QString& educationLevel, int grade, int classNum, int weekNum, bool updated);
