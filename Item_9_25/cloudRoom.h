...
public:
    virtual bool addTheData(QString id,void* item,bool send=true)   = 0;
    virtual bool deleTheData(QString id,bool send=true)  = 0;
    virtual bool modifTheData(QString id,void* item,bool send=true) = 0;
...
public:
    ...
    uint8_t changeNum(uint8_t num);

signals:
    void dataChange(uint8_t new_num);//data更改信号
...
private slots:
    ...
    virtual void UpdateData(uint8_t new_num) = 0;  //本地更新data
